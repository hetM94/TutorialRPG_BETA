...
//import net.het.tutorialrpg.event.GameEventsBus;
...
//                                    IMana manaCap = Objects.requireNonNull(player.getCapability(ModCapability.MANA));
...
//                            Player player = context.getSource().getPlayerOrException();
//                            IMana manaCap = Objects.requireNonNull(player.getCapability(ModCapability.MANA));
//                            int mana = Objects.requireNonNull(player.getCapability(ModCapability.MANA)).getMana();
//                            context.getSource().sendSuccess(() ->
